...
\thiswatermark{\centering \put(112,-550){\transparent{0.3}\includegraphics[scale=2]{LundUniversity_C_RGB.png}} }
...
\thiswatermark{\centering \put(0,-100){\includegraphics[width=3.5cm]{LundUniversity_C_RGB}} \put(260,-650){\transparent{1}\includegraphics[width=3cm]{kthlogo}\includegraphics[width=3cm]{riselogo}} }
